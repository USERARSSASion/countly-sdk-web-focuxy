        ...
        **/
        ...
        function processWidget(currentWidget, hasSticker) {
            ...
            try {
                ...
                var baseUrlPath = window.location.href.replace(window.location.origin, '');
                iframe.src = self.url + "/feedback?widget_id=" + currentWidget._id + "&app_key=" + self.app_key + '&device_id=' + self.device_id + '&sdk_version=' + SDK_VERSION + '&path=' + baseUrlPath;
                // inject them to dom
                document.body.appendChild(wrapper);
